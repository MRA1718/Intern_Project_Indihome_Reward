    ...
    <div class="d-flex justify-content-center">
      <div class="col-12 col-sm-9 col-md-6 mb-3">
      	<div class="pr-2 pb-2 text-right">
            <a href="<?= base_url("import"); ?>" class="btn btn-secondary" role="button">PS Harian</a>
            <a class="btn btn-light">PS Bulanan</a>
        </div>
        <div class="card shadow mb-4">

          <div class="card-header pt-3 pb-2">
            <h6 class="m-0 font-weight-bold text-gray">Unggah File PS Bulanan (.xls)</h6>
          </div>
          <div class="col text-center pt-2 pl-2 pr-2">
            <?= $this->session->flashdata('message') ?>
          </div>
          <form action="<?= base_url() ?>import/import_ps_bulanan" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                <div class="col">
                  <div class="custom-file">
                    <input type="file" id="file" name="file" class="custom-file-input" required accept=".xls">
                    <label class="custom-file-label" for="file"> Pilih File PS Bulanan </label>
                  </div>
                </div>
                <br>
                <div class="col">
